...
span.tagcloud8  { font-size: 16px;}
span.tagcloud9  { font-size: 16px;}
span.tagcloud10 { font-size: 17px;}
span.tagcloud11 { font-size: 17px;}
span.tagcloud12 { font-size: 18px;}
span.tagcloud13 { font-size: 18px;}
span.tagcloud14 { font-size: 19px;}
span.tagcloud15 { font-size: 19px;}
span.tagcloud16 { font-size: 20px;}
span.tagcloud17 { font-size: 20px;}
span.tagcloud18 { font-size: 21px;}
span.tagcloud19 { font-size: 21px;}
span.tagcloud20 { font-size: 22px;}
span.tagcloud21 { font-size: 22px;}
span.tagcloud22 { font-size: 23px;}
span.tagcloud23 { font-size: 23px;}
